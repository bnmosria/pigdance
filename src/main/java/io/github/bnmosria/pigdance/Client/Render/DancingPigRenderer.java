...
public class DancingPigRenderer extends MobRenderer<DancingPigEntity, DancingPigModel<DancingPigEntity>> {
    private static final ResourceLocation DANCING_PIG_TEXTURES = new ResourceLocation("textures/entity/pig/pig.png");

    public DancingPigRenderer(EntityRendererManager renderManagerIn) {
        super(renderManagerIn, new DancingPigModel<>(), 0.7F);
        this.addLayer(new SaddleLayer<>(this, new DancingPigModel<>(0.5F), new ResourceLocation("textures/entity/pig/pig_saddle.png")));
    }
